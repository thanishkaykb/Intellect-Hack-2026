...
export function AmbientBackground() {
  return (
    <div aria-hidden="true" className="pointer-events-none fixed inset-0 -z-10 overflow-hidden">
      ...
      />
      <div className="absolute -top-40 -left-40 h-[42rem] w-[42rem] rounded-full bg-[radial-gradient(circle,oklch(0.45_0.16_18/45%),transparent_65%)] blur-3xl" />
      <div className="absolute top-1/3 -right-52 h-[38rem] w-[38rem] rounded-full bg-[radial-gradient(circle,oklch(0.38_0.14_12/40%),transparent_65%)] blur-3xl" />
